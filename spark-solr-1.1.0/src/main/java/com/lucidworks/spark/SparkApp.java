...
import com.lucidworks.spark.example.hadoop.HCASolrIngestor;
...
import com.lucidworks.spark.example.hadoop.NestedSolrRDDProcessor;
...
public class SparkApp implements Serializable {
  ...
  private static RDDProcessor newProcessor(String streamProcType) throws Exception {
    ...
    else if ("nested-collection".equals(streamProcType))
        return new NestedSolrRDDProcessor();
    else if ("hca-ingestor".equals(streamProcType))
        return new HCASolrIngestor();
